...
AmazonS3_node1779689537324 = glueContext.getSink(path="s3://stedi-project-vivek/customer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1779689537324")
AmazonS3_node1779689537324.setCatalogInfo(catalogDatabase="stedi",catalogTableName="customer_trusted")
AmazonS3_node1779689537324.setFormat("glueparquet", compression="snappy")
AmazonS3_node1779689537324.writeFrame(SQLQuery_node1779689492583)
job.commit()
