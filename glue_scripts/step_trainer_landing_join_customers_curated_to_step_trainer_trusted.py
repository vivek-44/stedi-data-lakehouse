...
AmazonS3_node1779688858829 = glueContext.getSink(path="s3://stedi-project-vivek/step_trainer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1779688858829")
AmazonS3_node1779688858829.setCatalogInfo(catalogDatabase="stedi",catalogTableName="step_trainer_trusted")
AmazonS3_node1779688858829.setFormat("glueparquet", compression="snappy")
AmazonS3_node1779688858829.writeFrame(SQLQuery_node1779688703585)
job.commit()
